...
public class PushService extends Service {
	...
	private static final String MQTT_HOST = "mqtt.nodebus.com";
	...
	// MQTT broker.
	public static String MQTT_CLIENT_ID = "nodebus";
	...
	// Notification title
	public static String NOTIF_TITLE = "Nodebus";
	// Notification id
	...
	private synchronized void connect() {
		...
		if (token == null) {
			...
			try {
				mConnection = new MQTTConnection(MQTT_HOST, token);
	...
	private void showNotification(String text) {
		...
		n.icon = com.nodebus.android.R.drawable.icon;
		n.when = System.currentTimeMillis();

		// Simply open the parent activity
		PendingIntent pi = PendingIntent.getActivity(this, 0, new Intent(this,
				NodebusActivity.class), 0);
